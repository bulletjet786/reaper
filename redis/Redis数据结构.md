...
![Ziplist](https://tva1.sinaimg.cn/large/007S8ZIlly1gh850ywvmkj30oh0653yd.jpg)
...
和ziplist一样，也是一种使用数组实现的平面数据类型，目标是能取代ziplist,和ziplist相比，主要是解决了如下问题：
1. zlentry的prevlen字段依赖于上一个zlengty，受上一个zlengty的影响，不符合设计原则，也增加了增删改的复杂度
2. 因zlentry之间的依赖性，导致会产生级联更新现象

### 数据结构

![Listpack](https://tva1.sinaimg.cn/large/007S8ZIlly1gh851kw5b9j30l5065glg.jpg)
```
